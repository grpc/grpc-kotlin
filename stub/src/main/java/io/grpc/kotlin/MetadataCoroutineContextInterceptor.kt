...
/**
 * A server interceptor which propagates gRPC Metadata (HTTP Headers) to coroutineContext. To use it
 ...
 * coroutineContext. Example usage: coroutineContext[MetadataElement]?.value
 */
