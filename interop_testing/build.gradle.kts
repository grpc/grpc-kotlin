...
dependencies {
  ...
  testImplementation(libs.okhttp) { because("transitive dep for grpc-okhttp") }
}
...
val testServiceClientStartScripts =
  tasks.register<CreateStartScripts>("testServiceClientStartScripts") {
...
val testServiceServerStartScripts =
  tasks.register<CreateStartScripts>("testServiceServerStartScripts") {
